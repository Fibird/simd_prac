...
int main()
{
    ...
    printf("SIMD nest loop join v2 (cycles)\n");
    printf("\t");
	int step;
    for (step = 10; step <= 100; step+=10)
	printf("%d%\t", step);
    printf("\n");
	/*SIMD nest loop join v2 for L1 cache sets*/
	printf("L1\t");
    for (step = 10; step <= 100; step+=10){
	...
	printf("\n");
	/*SIMD nest loop join v2 for L2 cache sets*/
	printf("L2\t");
    for (step = 10; step <= 100; step+=10){
	...
	printf("\n");
	/*SIMD nest loop join v2 for L3 cache sets*/
	printf("L3\t");
    for (step = 10; step <= 100; step+=10){
	...
	printf("\n");
	/*SIMD nest loop join v2 for LLC cache sets*/
	printf("LLC\t");
    for (step = 10; step <= 100; step+=10){
